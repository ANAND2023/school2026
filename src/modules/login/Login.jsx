...
try {
  ...
  <div className="row h-100">
    ...
    //     {/* LEFT PANEL */}
    //     <div className="col-md-7 d-none d-md-flex flex-column justify-content-center align-items-center position-relative">
    //       <img src={logo} alt="logo" className="mb-3" style={{ height: 170 }} />
    //       <h2 className="fw-bold text-primary text-center">
    //         VIDYAALAY <span className="text-danger">MANAGEMENT</span> SOFTWARE
    //       </h2>
    //     </div>
    ...
    //           Welcome to <span className="text-danger">DigitalVidyaSaarthi</span>
    //         </h5>
    ...
    //             <MdKey className="position-absolute top-50 start-0 translate-middle-y ms-3 text-muted" />
    //             <input
    //               type={showPassword ? 'text' : 'password'}
    //               className="form-control ps-5"
    //               placeholder="Enter Password"
    ...
    //             />
    //             <span
    //               className="position-absolute top-50 end-0 translate-middle-y me-3 fs-5 cursor-pointer"
