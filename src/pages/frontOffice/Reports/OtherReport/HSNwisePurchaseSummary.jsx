...
import { Report_Formate_BasicAvg, Report_Formate_Pharmacy } from "../../../../utils/constant";
...
const HSNwisePurchaseSummary = () => {
  ...
  return (
    <div className="card">
      <Heading title={"HSN Wise Purchase Summary"} isBreadcrumb={false} />
...
export default HSNwisePurchaseSummary;
