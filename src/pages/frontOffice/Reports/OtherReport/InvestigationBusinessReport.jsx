...
import { BindStoreGroup } from '../../../../networkServices/InventoryApi';
import { useLocalStorage } from '../../../../utils/hooks/useLocalStorage';

const InvestigationBusinessReport = ({ reportTypeID }) => {
 ...
 {/* <ReactSelect
                ...
                {/* <div className="col-xl-2 col-md-4 col-sm-6 col-12 ">
                        <div className="d-flex align-items-center gap-2">
                            ...
                            <label htmlFor="IsLogo" className="mr-2">Is Logo</label>
                            <input
                                type="checkbox"
                                name="isLogo"
                                checked={values?.isLogo || false}
...
export default InvestigationBusinessReport;