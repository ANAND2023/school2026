...
function BloodCollection() {
  ...
  const handleSearchData = async () => {
    ...
    try {
      const response = await bloodCollectionSearchData(payload);
      if (response.success) {
  ...
  const theadbloodCollection = [
    { width: "5%", name: t("SNo") },
    { width: "15%", name: t("Donor ID") },
    { width: "15%", name: t("Bag Type") },
    { width: "10%", name: t("Bag Volume") },
    { width: "15%", name: t("Donor Name") },
    { width: "15%", name: t("Sex") },
    { width: "15%", name: t("Group") },
    { width: "10%", name: t("Reg. Date") },
  ...
  return (
    <>
      ...
      <div className="m-2 spatient_registration_card card">
        <Heading title={t("Blood Collection")} isBreadcrumb={false} />
          ...
          <div className="card">
            <Tables
              ...
              tbody={bloodCollectionData?.map((val, index) => ({
                sno: index + 1,
                donorId: val.Visitor_ID,
                bagType: val.BagType || "",
                bagVolume: val.Quantity || "",
                donorName: val.Name || "",
                // sexGroup: val.Male || "",
