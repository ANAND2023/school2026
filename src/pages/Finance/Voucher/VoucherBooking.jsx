...
function VoucherBooking() {
  ...
  const handleAttach = (value, index) => {
  ...
  return (<>
      ...
      <div className="patient_registration card">
        ...
        <div className="row p-2">
          <ReactSelect
            ...
            isDisabled={bodyData?.length > 0 ? true : false}
          ...
          <DatePicker
            ...
            id="VoucherDate"
            name="VoucherDate"
            value={values?.VoucherDate ? moment(values?.VoucherDate).toDate() : new Date}
            maxDate={new Date()}
          ...
          <div className="col-xl-2 col-md-4 col-sm-6 col-12">
            <LabeledInput label={t("Actual Conversion Factor")} value={values?.Actual ? values?.Actual : ""} />
          </div>
          ...
          <ReactSelect
            ...
            respclass="col-xl-2 col-md-4 col-sm-6 col-12"
          />
          {["PB", "BP", "BR", "CR", "CP", "SV"]?.includes(values?.VoucherType?.value) && values?.VoucherType?.extraColomn !== "All" && <>
            <div className="col-xl-4 col-md-8 col-sm-6 col-12 ">
              <AutoComplete
                value={values?.AccountType?.TextField ? values?.AccountType?.TextField : values?.AccountType}
                suggestions={items}
                completeMethod={(e) => { search(e, "AccountType") }}
                onChange={(e) => setValues({ ...values, AccountType: e.value })}
                className="w-100 required-fields"
                onSelect={(e) => validateInvestigation(e, "AccountType")}
                id="AccountType"
              ...
              >
                {t(values?.VoucherType?.extraColomn?.split("#")[1])}
              </label>
            </div>
            {values?.AccountTypeValue?.AccountName &&
              <div className="col-xl-2 col-md-4 col-sm-6 col-12">
                <LabeledInput label={t(values?.VoucherType?.extraColomn?.split("#")[1]) + " " + t("Value")} value={values?.AccountTypeValue?.AccountName} />
              </div>}
          </>
          }
          <ReactSelect
            ...
            id="ChartOfGroup"
            name="ChartOfGroup"
            value={values?.ChartOfGroup?.value}
            removeIsClearable={true}
            handleChange={(name, e) => handleReactSelect(name, e)}
    ...
    <div className="mt-2 spatient_registration_card">
      <div className="patient_registration card">
        ...
        {list?.length > 0 && <VoucherBookingTable tbody={bodyData} setOldBodyData={setBodyData} list={list} values={values} />}
      ...
      <div className="mt-2 spatient_registration_card">
        <div className="patient_registration card">
          <div className="row px-2 pt-2">
            <div className="col-9">
              <div className="row">
                {Object.keys(amounts)?.map((val) => {
                  return <div className="col-xl-2 col-md-4 col-sm-6 col-12 mb-2">
            ...
            <div className="col-3">
              <div className="row">
                <div className="col-xl-4 col-md-4  col-12 mb-2 ">

                  <BrowseButton
                    label={t("Browse")}
                    handleImageChange={handleImageChange}
                    className={`btn-primary  w-100 px-xl-3`}
                    value={values?.documentBase64}
                  />
                </div>
                <div className="col-xl-4 col-md-4  col-12  mb-2">
                  <button className="btn btn-sm btn-primary  w-100 px-xl-2 " type="button" onClick={handleSave}>
                     {t(values?.isEdit ? "Update" : "Save")}
                  </button>
                </div>
                {/* <div className="col-xl-4 col-md-4  col-12  mb-2 ">
                  <button className="btn btn-sm btn-primary w-100 px-xl-3" type="button" style={{ backgroundColor: "#61368b" }} onClick={ReplicateModalOpen}>
                    {t("Replicate")}
                  </button>
                </div> */}
      ...
      <div className="patient_registration card">
        ...
        <Tables
          ...
          tbody={voucherList?.map((val, index) => ({
            ...
            Attach: <i className="fa fa-paperclip" aria-hidden="true" onClick={() => { handleAttach(val, index) }}></i>,
          }))}
        />
      </div>
    </div>
