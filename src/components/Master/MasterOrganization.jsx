...
const MasterOrganization = () => {
  const tabs = [
    { id: 'OrganizationMaster', label: 'OrganizationMaster', icon: Home, color: '#6f42c1', component: <OrganizationMaster /> },
    { id: 'Branch', label: 'Branch', icon: Home, color: '#6f42c1', component: <Branch /> },
