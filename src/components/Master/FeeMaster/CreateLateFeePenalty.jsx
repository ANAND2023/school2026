...
function CreateLateFeePenalty() {
  ...
  const getData = async () => {
    ...
    try {
      const res = await GetAllLateFeePenalties(payload);
      if (res?.success) {
  ...
  const handleSave = async () => {
    ...
    try {
      const res = await AddLateFeePenalty(payload);
      if (res?.success) {
...
export default CreateLateFeePenalty;
