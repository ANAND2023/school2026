...
import { PrintSVG, ReprintSVG } from "../../../SvgIcons";
import { MedicineRequisitionGrdRequsition_RowCommand } from "../../../../networkServices/Emergency";
import { OpenPDFURL } from "../../../../networkServices/PDFURL";

const index = ({ tbody, tableHeight, editMedicineDetail }) => {
    ...
    const thead = [
        ...
        { name: t("EmergencyModule.RequisitionDate"), width: "10%" },
        t("EmergencyModule.RequisitionNo"),
        // t("EmergencyModule.ItemName"),
        // t("EmergencyModule.UnitType"),
        t("EmergencyModule.DepartmentFrom"),
        t("EmergencyModule.RaisedBy"),
        { name: t("EmergencyModule.Print"), width: "1%" },
        { name: "View", width: "1%" },
    ]
    ...
    const bindBodyData = (tbody) => {
        ...
        tbody?.map((val, index) => {
            ...
            obj.dtentry = val?.dtentry,
                ...
                // obj.DeptTo = val?.Deptfrom,
                // obj.ItemName = val?.ItemName,
                // obj.UnitType = val?.UnitType,
                // obj.ReqQty = val?.ReqQty ? val?.ReqQty : "0",
                // obj.ReceiveQty = val?.ReceiveQty ? val?.ReceiveQty : "0",
                // obj.PendingQty = val?.PendingQty ? val?.ReqQty : "0",
