...
export const BindInvListBox = async (payload) => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(`${apiUrls.BindInvListBox}?Department=${payload}`, {
      method: "get",
    });
...
export const GetDocTypeList = async (payload) => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(`${apiUrls.GetDocTypeList}?Type=${payload}`, {
      method: "get",
    });
...
export const BindSampleType = async () => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(`${apiUrls.BindSampleType}`, {
      method: "get",
      // data:payload
    });
...
export const BindAnatomicSite = async () => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(`${apiUrls.BindAnatomicSite}`, {
      method: "get",
      // data:payload
    });
...
export const createPatientTransferCheckApi = async (payload) => {
  try {
    const url = `${apiUrls.createPatientTransferCheck}`;
    const data = await makeApiRequest(url, {
      method: "POST",
      data: payload,
    });
...
export const technicianDoctorDefaultMappingApi = async (payload) => {
  try {
    const url = `${apiUrls.technicianDoctorDefaultMapping}`;
    const data = await makeApiRequest(url, {
      method: "POST",
      data: payload,
    });
...
export const deleteTechnicianDoctorDefaultMappingApi = async (id) => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(`${apiUrls.deleteTechnicianDoctorDefaultMapping}?id=${id}`, {
      method: "post"
    });
...
export const getAllActiveTechnicianDoctorMappingsApi = async (id) => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(`${apiUrls.getAllActiveTechnicianDoctorMappings}`, {
      method: "get",
    });
...
export const SearchSurgeryItem = async (id) => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(
      `${apiUrls.SearchSurgeryItem}?nameChange=${id}`,
      {
        method: "get",
      }
    );
...
export const UpdateInvestigation = async (payload) => {
  store.dispatch(setLoading(true));
  const options = {
    method: "Post",
    data: payload,
  ...
  try {
    const data = await makeApiRequest(`${apiUrls.UpdateInvestigation}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const SaveNewInvestigation = async (payload) => {
  store.dispatch(setLoading(true));
  const options = {
    method: "Post",
    data: payload,
  ...
  try {
    const data = await makeApiRequest(`${apiUrls.SaveNewInvestigation}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
// export const RateSetupCaseTypeBind = async (ID) => {
//   store.dispatch(setLoading(true));
//   try {
//     const data = await makeApiRequest(
//       `${apiUrls.RateSetupCaseTypeBind}`,
...
export const EDPLoadEmployee = async (roleID) => {
  ...
  try {
    store.dispatch(setLoading(true));
    const url = `${apiUrls.EDPuserRightsLoadEmployee}?roleID=${roleID}`;
    const data = await makeApiRequest(url, {
      method: "get",
    });
    store.dispatch(setLoading(false));
...
export const handleSaveRoleCentreAPI = async (payload) => {
  store.dispatch(setLoading(true));
  ...
  try {
    ...
    const data = await makeApiRequest(
      apiUrls.SavesRolesMappingsDetailsURL,
      options
    );
    store.dispatch(setLoading(false));
    return data;
...
// by Anand .......
export const FeedBackSaveQuestionMaster = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.FeedBackSaveQuestionMaster}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const SaveQuestionDepartment = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.SaveQuestionDepartment}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const FeedBackSaveQuestionType = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.FeedBackSaveQuestionType}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const GetQuestionDepartment = async () => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(
      `${apiUrls.GetQuestionDepartment}`,
      {
        method: "get",
      }
    );
...
export const FeedBackGetQuestionType = async () => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(
      `${apiUrls.FeedBackGetQuestionType}`,
      {
        method: "get",
      }
    );
...
export const BindEmployeeFeedBack = async () => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(
      `${apiUrls.BindEmployeeFeedBack}`,
      {
        method: "get",
      }
    );
...
export const SavePatientFeedBack = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.SavePatientFeedBack}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const FeedBackSearchQuestionMaster = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.FeedBackSearchQuestionMaster}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const FeedBackSaveQuestionSequence = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.FeedBackSaveQuestionSequence}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const FeedBackDeleteQuestionMaster = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.FeedBackDeleteQuestionMaster}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const OPDGetPackageReport = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.OPDGetPackageReport}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const OPDPackageReport = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.OPDPackageReport}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const OPDOpenandClosePackage = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.OPDOpenandClosePackage}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const BillFinalReport = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.BillFinalReport}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const runManualSchedularApi = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.runManualSchedular}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const PackageDetail_report = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "get",
    ...
    const data = await makeApiRequest(`${apiUrls.PackageDetail_report}?LedgerTransactionNo=${params}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const OPDPackageSummaryReport = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.OPDPackageSummaryReport}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const FeedBackFeedBackReport = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.FeedBackFeedBackReport}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const FeedBackSummaryComparisonReportApi = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.FeedBackSummaryComparisonReport}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const OPDAdvancCRMFundReport = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.OPDAdvancCRMFundReport}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const OPDGetPanelReport = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "get",
    ...
    const data = await makeApiRequest(`${apiUrls.OPDGetPanelReport}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const FeedBackUpdateQuestionMaster = async (params) => {
  store.dispatch(setLoading(true));
  try {
    const options = {
      method: "POST",
    ...
    const data = await makeApiRequest(`${apiUrls.FeedBackUpdateQuestionMaster}`, options);
    store.dispatch(setLoading(false));
    return data;
  } catch (error) {
    store.dispatch(setLoading(false));
...
export const SearchPatientFeedBack = async (payload) => {
  store.dispatch(setLoading(true));
  try {
    const data = await makeApiRequest(
      `${apiUrls.SearchPatientFeedBack}?PatientID=${payload?.PID}&Date=${payload?.Date}&Type=${payload.Type}&QuestionTypeId=${payload?.QuestionTypeId}`,
      {
        method: "get",
      }
    );
